...
import '../models/recipe.dart'; // Make sure this import points to where your Recipe model is defined
...
class NewRecipeScreenState extends State<NewRecipeScreen> {
  ...
  // Initialize TextEditingController instances with specific recipe values
